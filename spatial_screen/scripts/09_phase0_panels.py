"""Render Phase 0 prototype panels b, c, d as choropleths + bar chart.
...
Outputs:
  - figures/fig4_phase0_panel_b_choropleth.png   exposure index choropleth
  - figures/fig4_phase0_panel_c_choropleth.png   5-class panel c choropleth
  - figures/fig4_phase0_panel_d_stacked.png      cropland Mha by class × region
  - figures/fig4_phase0_assembled.png            quick 2x2 assembly
"""
...
def assembled(out: Path) -> None:
    ...
    files = [
        ...
        ("Panel b — exposure",      DIR_FIGURES / "fig4_phase0_panel_b_choropleth.png"),
        ("Panel c — combined",      DIR_FIGURES / "fig4_phase0_panel_c_choropleth.png"),
        ("Panel d — area × class × region", DIR_FIGURES / "fig4_phase0_panel_d_stacked.png"),
    ]
    for ax, (lbl, path) in zip(axes.ravel(), files):
        ...
        ax.set_axis_off()
    fig.suptitle(f"Figure 4 (Phase 0 prototype, country-level only) — "
...
def main() -> int:
    print("Rendering Phase 0 prototype panels ...")
    vul = pd.read_csv(DIR_PROCESSED / "vulnerability_country.csv")
    world = load_world()

    panel_b(world, vul, DIR_FIGURES / "fig4_phase0_panel_b_choropleth.png")
    panel_c(world, vul, DIR_FIGURES / "fig4_phase0_panel_c_choropleth.png")
    panel_d(vul,  DIR_FIGURES / "fig4_phase0_panel_d_stacked.png")
    assembled(DIR_FIGURES / "fig4_phase0_assembled.png")
    return 0
