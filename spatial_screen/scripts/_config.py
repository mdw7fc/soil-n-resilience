"""Shared configuration for figure4-resilience-map pipeline.

All paths, constants, thresholds, and FAOSTAT/SoilGrids URLs live here so every
script imports from a single source of truth. Per project standards, every value
that drives the figure must be greppable in this file.
"""
from pathlib import Path

# ---------------------------------------------------------------------------
# Project root (figure4-resilience-map directory)
# ---------------------------------------------------------------------------
