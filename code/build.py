...
NODES: List[Node] = [
    ...
    Node("fourpool_comparison", "code/repro/run_4pool_comparison.py",
         outputs=("results/fourpool_comparison.json",
                  "outputs/Table_S2_fourpool_sol.csv",
                  "figures/Figure_S5_fourpool_flux.png",
                  "figures/Figure_S5_fourpool_flux.pdf"),
         inputs=(ERA5,),
         libs=("code/model/som_4pool_monthly.py",
               "code/model/coupled_4pool.py"),
         minutes=1.0,
         note="structural engine comparison (Supplementary Note 2, table 2, "
              "Figure S5): microbially-explicit 4-pool vs Century under the "
              "matched SC1 scenario; F-029 reinstated the quantitative "
              "comparison the second/third audits had withdrawn, now "
