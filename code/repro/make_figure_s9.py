...
Writes: ../../figures/Figure_S9_mc_ensemble.png
...
DATA_FILE = ROOT_DIR / 'data' / 'mc_ensemble' / 'mc_posterior.csv.gz'
...
def main():
    ...
    out_png = FIG_DIR / 'Figure_S9_mc_ensemble.png'
    out_pdf = FIG_DIR / 'Figure_S9_mc_ensemble.pdf'
