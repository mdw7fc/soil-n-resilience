...
# Path setup (canonical deposit layout: code/repro/ -> code/model/, data/)
...
DEPOSIT_DATA = ROOT_DIR / 'data'
DATA_DIR = DEPOSIT_DATA / 'mc_ensemble'
...
def patch_era5() -> None:
    """Swap the built-in expert climate profiles for the canonical ERA5 normals.

    v1.3 change: the published (v12) ensemble ran on the model's built-in
    expert climate, whereas every other result in the paper derives from the
